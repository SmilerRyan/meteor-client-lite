...
public class InfinityMiner extends Module {
    ...
    public InfinityMiner() {
        super(Categories.Meteor, "infinity-miner", "Allows you to essentially mine forever by mining repair blocks when the durability gets low. Needs a mending pickaxe.");
    }
